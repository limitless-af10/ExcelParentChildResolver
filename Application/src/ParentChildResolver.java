...
public class ParentChildResolver {
	...
	public static void resolve(WorkbookRead workbook, WorkbookWrite updated_workbook, int headerRow, int parentColumns) {
    ...
    public static void resolveParentChild(ArrayList<Object> parent_data, Row nextRow, Sheet spreadsheet, int row_number) {
    	Iterator<Cell> cellIterator = nextRow.cellIterator();
